# -*- coding: utf-8 -*-
"""Training_Diffusion_Models_celebahq256.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1YU_x599yRRpPio0ZW3WA-GdmDWeCiXfw

<h2 style='text-align: center;'>Diffusion Models</h2>
...
# # !pip install diffusers[training] wandb
# !pip show diffusers
...
# !cp "/content/drive/MyDrive/<CHANGE_THIS_TO_PATH_ON_YOUR_DRIVE>/celeba_hq_256.zip" /content/
...
Build on the above code base and train your own diffusion model to generate Human Faces. Follow the instructions on the project sheet provided.  
"""